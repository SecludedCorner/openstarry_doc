...
> 判定理由（掃描原文）：Presents the never-built broker-based MCP listener/sender as the current architecture ('在新的架構中'); no message_broker service or eventQueue.push API ever shipped; same MCP name collision as doc 01.
