...
> 判定理由（掃描原文）：Canvas drawing UI and device sensors (GPS/camera/accelerometer via React Native/Flutter/Tauri bridge) were never built; pure aspiration written as worked examples on the fictional plugin.json model.
