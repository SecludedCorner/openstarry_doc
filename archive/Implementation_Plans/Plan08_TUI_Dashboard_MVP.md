...
1. **New Plugin**: `@openstarry-plugin/tui-dashboard` with IUI (色蘊·輸出) + IListener (色蘊·輸入) interfaces
...
/**
 * TuiListener implements IListener interface (色蘊·輸入).
 ...
 * - TuiListener (色蘊·輸入) — receives user input
 *
