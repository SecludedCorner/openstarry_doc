...
## Target
Implement Phases 1~4 to achieve the **MVP v0.1 Alpha** milestone:
- Local CLI Agent operational.
...
- **Monorepo**: `openstarry/` containing `apps/` and `packages/`.
- **Plugin Ecosystem**: `openstarry_plugin/` (flat structure, separate repository).
