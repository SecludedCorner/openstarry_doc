...
> 判定理由（掃描原文）：Entire doc designs around a shared backend Sandbox Manager (Docker lifecycle, sandbox_fs:* tools, python:execute via sandbox) that was never built — same fiction layer as Tool_CodeInterpreter_Example and the Daemon infrastructure in Tech Specs 01-07.
