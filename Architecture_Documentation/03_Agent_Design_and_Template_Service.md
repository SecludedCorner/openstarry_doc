...
> 判定理由（掃描原文）：Runtime REST template service (POST /templates, PUT .../plugins) never built — real system uses static agent.json configs; presented as CURRENT fact with no banner.
