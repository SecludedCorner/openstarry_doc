...
> 本架構深度融合「五蘊 (Five Aggregates)」思想，定義了五種蘊的工程映射：
> 1.  **色蘊 (Rupa — ISensory):** 物質交互層。UI (輸出顯相) + Listener (輸入感官)。
> 2.  **受蘊 (Vedana — ISensation):** 三受反饋系統 (苦/樂/捨)，橫跨系統的情感性評價機制。
> 3.  **想蘊 (Samjna — ICognition):** 認知引擎 (Provider)，涵蓋全光譜推理管線。
> 4.  **行蘊 (Samskara — IAction):** 執行能力 (Tool)，對外部世界產生影響。
> 5.  **識蘊 (Vijnana — IIdentity):** 我執框架 (Guide)，賦予身份認同與行為邊界。Core 體現緣起性空，是 Guide 賦予了它「識別」與「自我認同」。
